...
import { StyleSheet, Text, View, SafeAreaView, TextInput, 
    ScrollView, Alert, TouchableOpacity, TouchableWithoutFeedback, Image, 
...
async function uploadImageAsync(uri) {
    ...
    const sendMessage = function sendContent() {
        ...
        Firebase.app().firestore().collection('chats').doc(route.params.id).collection('messages').add({
            ...
            //imageMessage: image,
            photoURL: "https://cencup.com/wp-content/uploads/2019/07/avatar-placeholder.png", //just sets photo to a default, need to write function to set this in profile screen 
        })
